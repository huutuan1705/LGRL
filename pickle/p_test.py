...
train_sketch_pickle_dir = "./Test_sketch.pickle"
train_image_pickle_dir = "./Test_image.pickle"
...
def main(opt):
    ...
    for i_batch, sanpled_batch in enumerate(dataloader_sketchy_train):
        ...
        for i in range(len(sanpled_batch['sketch_img_part'])):
            ...
            sketch_feature_part_ALL = torch.cat((sketch_feature_part_ALL, feature_part.unsqueeze(0).detach()))
        ...
        sketch_text_pro.append(sanpled_batch['sum_all_d'])
    ...
    print(len(sketch_text_pro))
    print(sketch_text_pro[0])
